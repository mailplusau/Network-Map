 ...
 * @Last modified time: 2021-12-02T15:46:16+11:00
 */
...
function main(request, response){
    if (request.getMethod() === "GET") {
        ...
        if (role != 1000) {
            inlineHtml += '<div class="" style="padding-top: 30%;"><div class="form-group container"><div class="row"><div class="input-group"><span class="input-group-addon">SELECT ZEE</span><select class="form-control zee_dropdown" >';
            ...
            resultSet_zee.forEachResult(function(searchResult_zee) {
                ...
                if (request.getParameter('zee') == zeeid) {
                    inlineHtml += '<option value="' + zeeid + '" selected="selected">' + zee_name + '</option>';
                    zee = zeeid;
                } else {
                    inlineHtml += '<option value="' + zeeid + '">' + zee_name + '</option>';
                }
        ...
        if (!isNullorEmpty(zee)) {
            ...
            var network_json = partner_record.getFieldValue('custentity_lastmile_suburb_json');
      ...
      inlineHtml += '<div class="row">';
            ...
            inlineHtml += '<div id="map" style="width: 1000px; height: 500px"><div id="loader"><img src="https://1048144.app.netsuite.com/core/media/media.nl?id=2089999&c=1048144&h=e0aef405c22b65dfe546" alt="loader" /></div></div>';
            inlineHtml += '</br>';
            inlineHtml += '</br>';
            inlineHtml += '</br>';
            inlineHtml += '<div class="table-responsive"><table border="0" cellpadding="10" id="network_map" cellspacing="0" class="table table-striped text-centered" style="width: 100%;"><thead style="color: white;background-color: #607799;"><tr><th><b>ACTION</b></th><th><b>SUBURB</b></th><th><b>STATE</b></th></tr></thead><tbody><tr></tr>';
      ...
      inlineHtml += '</div>';
        ...
        partner_record.setFieldValue('custentity_lastmile_suburb_json', network_JSON);
        ...
        if (role == 1000) {
            ...
            nlapiSetRedirectURL('SUITELET', 'customscript_sl_lastmile_suburb_select', 'customdeploy1', null, params);
        }
