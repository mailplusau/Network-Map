 ...
 function (ui, email, runtime, search, record, http, log, redirect, task, format) {
     ...
     function onRequest(context) {
         if (context.request.method === 'GET') {
             ...
             inlineHtml += '<ul>Welcome to SendePlus. To Start, Select Franchisee. Once Selected, A list of suburbs will appear according to that Franchisees State Value. Select appropriate Primary and Secondary Driver Information and Save</ul>';
             ...
             form.addField({
                 id: 'custpage_sendleplus_operator_zee_id',
                 label: 'Zee ID',
             ...
             form.addField({
                 id: 'custpage_sendleplus_operator_zee_name',
                 label: 'Zee ID',
                 type: ui.FieldType.TEXT
             }).updateDisplayType({
                 displayType: ui.FieldDisplayType.HIDDEN
             ...
             form.addField({
                 id: 'custpage_sendleplus_operator_zee_state',
                 label: 'Zee ID',
                 type: ui.FieldType.TEXT
             }).updateDisplayType({
                 displayType: ui.FieldDisplayType.HIDDEN
             ...
             form.addField({
                 id: 'custpage_sendleplus_operator_selector',
             ...
             form.clientScriptFileId = 5176035; //5072356
     ...
     function dataTable(selector) {
         var inlineQty = '<style>table#data_preview_'+ selector +' {font-size: 12px;text-align: center;border: none; background-color: white;}.dataTables_wrapper {font-size: 14px;}table#data_preview_'+ selector +' th{text-align: center;} .bolded{font-weight: bold;}</style>';

         inlineQty += '<h4 id="primary_table_title" class="primary_table_title_'+selector+' hide" style="font-size: 25px; font-weight: 700; color: #103D39; text-align: center">Primary Table</h4>';
     ...
     function dataTable2(selector) {
         ...
         inlineQty += '<h4 id="secondary_table_title" class="secondary_table_title_'+selector+' hide" style="font-size: 25px; font-weight: 700; color: #103D39; text-align: center">Secondary Table</h4>';
         ...
         inlineQty += '<input class="form-control" id="filter_postcode" aria-describedby="filterPostCode" placeholder="Enter Post Code">';
         inlineQty += '</div></div>'
         ...
         inlineQty += '<input type="button" style="background-color: #FBEA51; color: #103D39; font-weight: 700; border-color: transparent; border-width: 2px; border-radius: 15px; height: 30px;" class="form-control search_filter" id="search_filter" value="Filter Table"></input>'
         inlineQty += '</div>'

         inlineQty += '<div class="col-xs-2">'
         inlineQty += '<input type="button" style="background-color: #FBEA51; color: #103D39; font-weight: 700; border-color: transparent; border-width: 2px; border-radius: 15px; height: 30px;" class="form-control clear_filter" id="clear_filter" value="Clear Table"></input>'
         inlineQty += '</div>'
